...
namespace UnitySDK.UI
{
    [AddComponentMenu("程序工具/UI/UIText", 10)]
    [ExecuteAlways]
    public class UIText : Text
    {
        ...
        */
        ...
        protected override void OnPopulateMesh(VertexHelper toFill)
        {
            ...
            if (m_EnableShadow)
                SetFontVertex(verts, m_ShadowOffset.normalized * (Length(m_ShadowOffset) + ShadowOffsetFixed), unitsPerPixel, toFill, m_ShadowCol, roundingOffset, m_ShadowScale + ShadowScaleFixed);
            ...
            for (int i = 0; i < vertCount; ++i)
            {
                ...
                if (m_EnableGradient)
                    m_TempVerts[tempVertsIndex].color = CalcOneDir(tempVertsIndex, verts, mdp) * ratio;
